import { setState } from '../state/gameState';
import { render } from '../main';

export function renderHome(): string {
  return `
    <div class="home">
      <div class="home__bg-controller" aria-hidden="true">
        <svg viewBox="0 0 120 80" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
          ...
          <circle cx="76" cy="42" r="0" opacity="0"/>
      ...
      <div class="home__content">
        ...
        <button class="btn btn--play" id="home-play-btn">
